...
export function buildEmailClassifierPrompt(input: {
  ...
  return [
    ...
    "",
    "Buckets:",
    "- reply: the operator should reply. Write a complete draft in draft_body using flowing paragraphs with one blank line between paragraphs.",
    "- action: the operator needs to do or review something outside a reply. draft_body must be null.",
