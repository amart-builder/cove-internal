    ...
    <article className="space-y-2">
      ...
      <div className="mr-auto max-w-[92%] rounded-2xl rounded-bl-md bg-muted px-3.5 py-2.5 text-sm leading-relaxed text-foreground">
        {needsClaudeSignIn || needsCodexSignIn ? (
          ...
          <p className="text-muted-foreground">
            {turn.error_code === 'provider_missing'
              ? `Cove cannot find the ${turn.provider === 'codex' ? 'Codex' : 'Claude'} command it thinks with. Ask your Cove setup agent to install it.`
              : 'Buddy was interrupted.'}
          </p>
        )}
        {partialOverflow && (
