---
name: cove-refine-today
description: Translate a user's Morning Arrival replanning message into safe, structured Cove task-card operations. Use when Cove asks Claude to create, update, complete, assign, or reprioritize the current day's tasks.
---
...
Never write to Cove storage directly. Cove validates and applies the structured operations after the session returns.
